import{s as u,R as f,j as i,_ as x}from"./styled-components.browser.esm-1bf82734.js";import{o as k,b,H as v}from"./src/newtab/index-3d1c810c.js";import{d as m}from"./index-85382f69.js";const I=(h,d)=>{const t=x.keyBy(h,"timeKey"),r=[];h.forEach(e=>{t[e.timeKey].children||(t[e.timeKey].children=[]),e.parentId===d?r.push(t[e.timeKey]):t[e.parentId]&&(t[e.parentId].children||(t[e.parentId].children=[]),t[e.parentId].children.push(t[e.timeKey]))});const o=e=>{e.children&&(e.children.sort((c,s)=>c.sort-s.sort),e.children.forEach(c=>o(c)))};r.forEach(o);const l=e=>({title:e.title,sort:e.sort,key:e.timeKey,id:e.linkId,children:e.children.map(c=>l(c))});return x.sortBy(r.map(e=>l(e)),"sort")},y=(h,d=null)=>{let t=[];return h.forEach((r,o)=>{const l={linkId:r.id,timeKey:r.key,parentId:d,sort:o};if(delete l.children,t.push(l),r.children&&r.children.length>0){const e=y(r.children,r.key);t=t.concat(e)}}),t},j=u.div`
    overflow: auto;
    padding: 10px 0;
`,w=u.div`
    display: flex;
